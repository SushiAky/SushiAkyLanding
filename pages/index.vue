    ...
    <NuxtLayout>
        ...
        <div class="bg-white py-16">
            ...
            <div class="pb-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="flex flex-col gap-5 lg:gap-8 mx-4">

                    <div class="">
                        <img class="object-cover w-full rounded-lg"
                            src="https://www.bonde.com.br/api/images/proxy?quality=100&src=https://www.bonde.com.br/img/bondenews/2018/03/img_1_33_2454.jpg"
                            alt="">
                    </div>
                    ...
                    <div class="mx-4">
                        ...
                        <p class="mt-4 text-left text-gray-500">description
                        </p>

                        <div class="flex justify-end mt-4">
                            <p class="text-xl font-bold text-red-700 lg:text-3xl">R$ price </p>
                        </div>

                        <div class="mt-4">
                            <button class="px-5 py-2.5 bg-black rounded-full text-white">
                                Adicionar
                            </button>
                        </div>
                    </div>
